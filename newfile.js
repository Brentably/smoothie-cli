...
function debuggerPrompt(prompt, options = {}) {
  return new Promise((resolve) => {
    ...
    // This function prompts the user for input and listens for data on stdin
    function promptUser() {
      promptLength = prompt.length // length of the prompt message
      process.stdout.write(prompt + 'Add even more: ') // write the prompt message to stdout
      process.stdin.on('data', onData) // listen for data on stdin
    }
